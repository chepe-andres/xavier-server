...
dnf install -y rsync plymouth samba cockpit cockpit-storaged cockpit-ws cockpit-machines cockpit-selinux cockpit-files cockpit-storaged just fzf wget git firewalld msedit fastfetch btop
